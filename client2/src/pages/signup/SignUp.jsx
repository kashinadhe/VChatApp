    ...
    return (
        <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
            <div className="h-full w-full bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-30 border border-gray-100">
                <h1 className="text-3x1 font-semibold text-center text-gray-300 pt-15">Sign Up</h1>
                <form onSubmit={handleSubmit} className='w-3/4 m-auto pb-5'>
                    <div>
                    ...
                    <div>
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            ...
                            <input type="password" className="grow" placeholder='Confirm your password'
